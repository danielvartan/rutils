...
test_that("convert.character() | warning test", {
    shush(expect_message(convert("1", "logical", quiet = FALSE),
                         "'x' was converted 'as is'."))
    shush(expect_message(convert("1", "duration", quiet = FALSE),
                         "'x' was converted 'as is'."))
    shush(expect_message(convert("1", "difftime", quiet = FALSE),
