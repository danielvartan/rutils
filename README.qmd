...
This package is primarily intended for personal use, but you are welcome to use it if you find it helpful. If you appreciate the project, consider giving it a star! (⭐)
...
`rutils` code is released under the [MIT license](https://opensource.org/license/mit/).
